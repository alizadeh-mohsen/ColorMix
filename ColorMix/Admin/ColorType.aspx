<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="ColorType.aspx.cs" Inherits="ColorMix.Admin.ColorType" %>
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="ID" HeaderText="ID" ReadOnly="True"
                            SortExpression="ID" />
                        <asp:TemplateField HeaderText="ColorType" SortExpression="ColorType">
                            <EditItemTemplate>
        ...
        <tr>
            <td>
                <asp:Panel ID="pnlAdd" runat="server" Visible="False">
                    Color Type:
            <asp:TextBox ID="txtColorType" runat="server"></asp:TextBox>
                    <br />
                    <br />
